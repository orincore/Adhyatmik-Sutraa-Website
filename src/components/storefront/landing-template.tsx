...
export function LandingTemplate({ data, pageContent, landingPageId, pageSlug, editorInstance, editorBridge }: LandingTemplateProps) {
  ...
  const sCta = (key: string): React.CSSProperties => {
    ...
    const base = s?.buttonColor ? ctaStyle(s.buttonColor, s.buttonColor) : ctaStyle(c.primary, c.accent);
      ...
      case 'announcementBar': {
        ...
        return (
          <div
            ...
            style={{
              ...sBgStyle('announcementBar', { backgroundImage: `linear-gradient(90deg, ${c.accent} 0%, ${c.primary} 100%)` }),
    ...
    >
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* Static, not looping: this bar is fixed and mounted for the whole
           ...
           page stayed open — a real source of sustained CPU/GPU load and
           device heat on lower-end phones. The glow, sheen and arrow now
           hold their resting frame instead of animating forever. */
