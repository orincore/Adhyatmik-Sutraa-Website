...
function HeroSection() {
  ...
  const baseSlides = [
    {
      ...
      badge: "Your Safe Space",
      badgeIcon: "crown",
      title: "WANT TO FEEL FREE",
      titleHindi: "& EMPOWERED?",
      subtitle: siteConfig.tagline,
      description: `${siteConfig.name} helps you connect with your inner self. Our tarot reader, numerologist, and angel healer Sonali Bhattacharya provides easy-to-follow guidance and insightful courses.`,
      quote: "\"We are your safe space to pour your difficult choices and clouded thoughts.\"",
    ...
    },
    {
      ...
      titleHindi: null,
      subtitle: "Tarot Reader, Numerologist & Angel Healer",
      description: "A holistic healer and life coach providing divine and tarot services for the last 10 years. She started as a Reiki healer and went on to offer tarot, numerology, angel healing, occult, and more.",
      quote: "\"10+ years of experience — 10,000+ people guided and counting\"",
    ...
    },
    {
      ...
      badge: "Our Courses",
      badgeIcon: "sparkles",
      title: "Learn the Divine Arts",
      titleHindi: "Courses & Teachings",
      subtitle: "Tarot · Angel Healing · Crystal Healing · Salt Magic",
      description: "Get started with tarot reading, angel healing, and other courses with Adhyatmik Sutraa. Sonali offers courses that will help you guide your clients.",
      quote: "\"50+ courses in occult and spiritual healing\"",
      cta1: { text: "View Courses", href: "/courses", icon: "gem" },
      cta2: { text: "Shop Products", href: "/shop", icon: "shopping" },
    },
    {
      id: 3,
      image: "/assets/about-founder.jpg",
      video: null,
      overlayGradient: "from-indigo-950/80 via-purple-900/60 to-violet-900/50",
      badge: "Why Choose Us",
      badgeIcon: "flower",
      title: "10,000+ People",
      titleHindi: "Guided & Counting",
      subtitle: "Confidential · Trustworthy · Experienced",
      description: "You will be charged only for the customized services on our platform — no hidden charges. Get clarity and trusted direction in your life.",
      quote: "\"Clear your mind, body, and emotional aura with our exact readings and angel healing.\"",
      cta1: { text: "Book a Session", href: "/booking", icon: "zap" },
  ...
  // Video slides are disabled for this brand — the hero videos in
  // /public/Homepage Hero are Pratipal-branded footage.
  void desktopVideoSlide;
  void mobileVideoSlides;
      ...
      <div className="relative z-10 container text-center">
        <div className="animate-slide-up">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-lg mb-4">
            ...
            <span className="text-emerald-100 text-sm font-medium tracking-wider">Connect With Your Inner Self</span>
          </div>
          ...
          <p className="text-xl text-emerald-200 italic max-w-2xl mx-auto mb-3">
            &ldquo;Clear your mind, body, and emotional aura&rdquo;
          </p>

          <p className="text-base text-white/70 max-w-3xl mx-auto leading-relaxed mb-6">
            We are your safe space to pour your difficult choices and clouded thoughts. Get guidance from our experienced tarot reader and numerologist to receive sharp reflection.
          </p>

          <div className="flex flex-wrap items-center justify-center gap-8">
            <div className="text-center">
              <div className="text-3xl font-serif font-bold text-gradient-peacock mb-2">10,000+</div>
              <div className="text-sm text-white/60 uppercase tracking-wider">People Guided</div>
            </div>

            <div className="w-px h-12 bg-gradient-to-b from-transparent via-white/30 to-transparent"></div>

            <div className="text-center">
              <div className="text-3xl font-serif font-bold text-gradient-peacock mb-2">10+</div>
            ...
            <div className="text-center">
              <div className="text-3xl font-serif font-bold text-gradient-peacock mb-2">50+</div>
              <div className="text-sm text-white/60 uppercase tracking-wider">Courses Offered</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-3 animate-slide-up">
            <div>
              ...
              <p className="text-base text-emerald-600 font-medium">
                 Tarot Reader, Numerologist & Angel Healer 🪷
              </p>
            </div>

            <div className="space-y-3 text-slate-700 leading-relaxed text-sm sm:text-base">
              <p>
                Sonali Bhattacharya is a <span className="font-semibold text-emerald-600">holistic healer and life coach</span>, providing divine and tarot services for the last <span className="font-bold text-teal-600">10 years</span>. She helps her clients with spiritual and emotional awakening.
              </p>
              <p>
                She started as a Reiki healer but went on to offer services like <span className="font-bold text-blue-600">tarot, numerology, angel healing, and occult practices</span>, alongside more than 50 courses in occult and spiritual healing.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl p-4 border border-emerald-100">
              <h4 className="font-semibold text-slate-800 mb-2 flex items-center gap-2 text-sm">
                ...
                Why Choose Adhyatmik Sutraa?
              </h4>
              <div className="space-y-1 text-sm text-slate-700">
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 mt-2 flex-shrink-0"></div>
                  <span>Guided over <span className="font-semibold">10,000 people</span> and counting</span>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-teal-500 mt-2 flex-shrink-0"></div>
                  <span>Confidential, trustworthy, and <span className="font-semibold">customized sessions</span> with no hidden charges</span>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                  <span><span className="font-semibold">50+ courses</span> in occult and spiritual healing</span>
                </div>
              </div>
            </div>
