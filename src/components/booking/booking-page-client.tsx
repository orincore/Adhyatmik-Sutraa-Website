...
const FALLBACK_SERVICES: ServiceItem[] = [
  { id: "1", title: "Personal Consultation & Healing", description: "A confidential 1-on-1 session with Sonali — customized healing tips and manifestation processes to remove hurdles and heal past traumas.", image_url: "https://adhyatmiksutraa.com/wp-content/uploads/2025/09/testimonial-header-1024x683.jpg", base_price: 999, frequency_options: [{ label: "30-Minute Session", value: "single", price: 999 }], category: "Consultation" },
  { id: "2", title: "Tarot Card Reading", description: "General life, love & relationship, career & finance, specific question, and past-present-future spreads — in English or Hindi.", image_url: "https://adhyatmiksutraa.com/wp-content/uploads/2025/09/a-woman-fortuneteller-tells-a-man-on-tarot-cards-2023-01-25-13-02-09-utc-1-2.jpg", base_price: 999, frequency_options: [{ label: "Per Reading", value: "single", price: 999 }], category: "Tarot" },
  { id: "3", title: "Angel Healing Session", description: "Release stress, attract positivity, and feel empowered with a personalized Angel Healing experience guided by the healing archangels.", image_url: "https://adhyatmiksutraa.com/wp-content/uploads/2025/09/main-banner-2.jpg", base_price: 999, frequency_options: [{ label: "30–45 Minute Session", value: "single", price: 999 }], category: "Healing" },
  { id: "4", title: "Group Sound & Light Healing", description: "Chimes, crystal singing bowls, and tones guide you towards light and healing — a mixture of reiki, IET, and other healing processes.", image_url: "https://adhyatmiksutraa.com/wp-content/uploads/2025/09/blog-header-1-1024x683.jpg", base_price: 999, frequency_options: [{ label: "Per Session", value: "single", price: 999 }], category: "Group" },
  { id: "5", title: "Numerology Consultation", description: "Decode the numbers that shape your life path and receive sharp, practical direction from an experienced numerologist.", image_url: "https://adhyatmiksutraa.com/wp-content/uploads/2025/09/advantages-bg.jpg", base_price: 999, frequency_options: [{ label: "Per Consultation", value: "single", price: 999 }], category: "Numerology" },
  { id: "6", title: "Black Magic & Evil Eye Removal", description: "Time-tested remedies to identify, cleanse, and protect against dark spiritual forces and restore peace and prosperity.", image_url: "https://adhyatmiksutraa.com/wp-content/uploads/2025/09/team-5.jpg", base_price: 999, frequency_options: [{ label: "Per Session", value: "single", price: 999 }], category: "Protection" },
];
...
const highlights = [
  { icon: Star, value: "10+", label: "Years Exp." },
  { icon: Users, value: "10,000+", label: "People Guided" },
  { icon: Crown, value: "50+", label: "Courses" },
  { icon: CheckCircle, value: "12+", label: "Modalities" },
];
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 items-center">
            <div className="hidden sm:block relative">
              <div className="relative w-full aspect-[4/4] max-w-md mx-auto lg:mx-0 rounded-2xl overflow-hidden shadow-2xl">
                <Image src="/assets/founder-sonali.jpeg" alt="Sonali Bhattacharya" fill className="object-cover object-top" sizes="(max-width: 768px) 100vw, 50vw" placeholder="blur" blurDataURL={BLUR} />
            ...
            <div className="space-y-3 sm:space-y-5 text-white">
              ...
              <p className="text-emerald-200 font-medium text-sm">Tarot Reader, Numerologist & Angel Healer</p>
              <p className="text-white/75 leading-relaxed text-sm">
                With 10+ years of experience in the occult and spiritual healing field, Sonali has guided over 10,000 people through tarot, numerology, angel healing, and holistic energy work.
              </p>
              <div className="grid grid-cols-2 gap-2">
                {["Reiki Healer", "Tarot Reader", "Numerologist", "Angel Healer"].map((tag) => (
