      ...
      <section className="relative overflow-hidden" style={{ minHeight: "clamp(260px, 40vw, 52vh)" }}>
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{ background: "linear-gradient(105deg, rgba(53,9,60,0.96) 0%, rgba(53,9,60,0.82) 55%, rgba(53,9,60,0.45) 100%)" }}
          />
        </div>
        ...
        <div className="relative z-10 flex items-center" style={{ minHeight: "clamp(260px, 40vw, 52vh)" }}>
          ...
          <div className="container max-w-6xl px-5 sm:px-8 py-14 sm:py-32">
            <div className="max-w-lg">
              ...
              >
                We're Here<br />
                <span style={{ color: "#FD4380" }}>to Help You</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 mt-4 sm:mt-0">
                <a
                  ...
                  style={{ background: "#FD4380", color: "#fff" }}
                >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 lg:divide-x lg:divide-white/10">
            {[
              ...
              >
                ...
                >
                  <Icon className="h-3.5 w-3.5 sm:h-4 sm:w-4" style={{ color: "#FD4380" }} />
                </div>
          ...
          <div className="grid lg:grid-cols-5 gap-6 sm:gap-10 lg:gap-14 items-start">
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border overflow-hidden" style={{ borderColor: "rgba(35,45,95,0.08)" }}>
                ...
                <div className="px-5 sm:px-7 py-4 sm:py-5 border-b" style={{ borderColor: "rgba(35,45,95,0.08)" }}>
                  <h2
                    ...
                    style={{ fontFamily: "'Marcellus', serif", color: "#35093C" }}
                  >
                    Send Us a Message
                  </h2>
                ...
                <div className="px-5 sm:px-7 py-5 sm:py-7">
                  {submitStatus.type && (
                    <div
                      ...
                      style={{
                        background: submitStatus.type === "success" ? "rgba(253,67,128,0.07)" : "rgba(239,68,68,0.07)",
                        border: `1px solid ${submitStatus.type === "success" ? "rgba(253,67,128,0.25)" : "rgba(239,68,68,0.25)"}`,
                        color: submitStatus.type === "success" ? "#9d1749" : "#991b1b",
                      }}
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                    <div className="grid grid-cols-2 gap-3 sm:gap-5">
                      <Field label="Full Name" required>
                        <Input id="name" name="name" type="text" value={formData.name}
                          ...
                          className="h-10 sm:h-11 rounded-lg border-0 bg-gray-50 text-[#35093C] placeholder:text-[#35093C]/30 focus-visible:ring-1 focus-visible:ring-[#FD4380] text-sm"
                    ...
                    <Field label="Message" required>
                      <Textarea id="message" name="message" value={formData.message}
                        ...
                        rows={4}
                        className="rounded-lg border-0 bg-gray-50 text-[#35093C] placeholder:text-[#35093C]/30 focus-visible:ring-1 focus-visible:ring-[#FD4380] resize-none text-sm"
                        style={{ fontFamily: "'Open Sans', sans-serif" }} />
                    </Field>
                    ...
                    <button
                      ...
                      style={{ background: "#35093C", fontFamily: "'Open Sans', sans-serif", letterSpacing: "0.03em" }}
                    >
                      {isSubmitting
            ...
            <div className="lg:col-span-2 space-y-5 sm:space-y-6">
                  ...
                  return (
                    ...
                    >
                      <div className="h-7 w-7 rounded-md flex items-center justify-center flex-shrink-0" style={{ background: label === "WhatsApp" ? "rgba(37,211,102,0.15)" : "rgba(217,119,69,0.12)" }}>
                        <Icon className="h-3.5 w-3.5" style={{ color: label === "WhatsApp" ? "#25D366" : "#FD4380" }} />
                      </div>
                      <div>
                        <p className="text-[9px] uppercase tracking-widest font-semibold" style={{ color: "rgba(35,45,95,0.4)" }}>{label}</p>
                        <p className="text-[11px] font-medium leading-snug mt-0.5" style={{ color: "#35093C" }}>{value}</p>
                      </div>
                    </El>
                  );
                })}
              ...
              <div className="hidden lg:block space-y-6">
                <div>
                  <p className="text-[10px] uppercase tracking-[0.25em] font-semibold mb-2" style={{ color: "#FD4380" }}>
                    Our Details
                  </p>
                  <h2
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={q}>
                        <p className="text-sm font-semibold mb-1" style={{ color: "#35093C" }}>{q}</p>
  ...
  return (
    <div className="space-y-1 sm:space-y-1.5">
      <label
        ...
        style={{ color: "rgba(35,45,95,0.55)", fontFamily: "'Open Sans', sans-serif" }}
      >
        {label}{required && <span className="ml-0.5" style={{ color: "#FD4380" }}>*</span>}
      </label>
      {children}
    </div>
  );
