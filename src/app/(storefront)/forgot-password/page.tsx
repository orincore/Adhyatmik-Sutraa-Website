  ...
  return (
    <div className="min-h-screen flex overflow-hidden">
      ...
      <div
        ...
        style={{ background: "linear-gradient(145deg, #240429 0%, #35093C 45%, #542b54 100%)" }}
      >
        <div className="absolute rounded-full opacity-15 pointer-events-none" style={{ width: 420, height: 420, top: -80, left: -80, background: "radial-gradient(circle, #ff94ba, transparent)" }} />
      ...
      <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50/30 overflow-y-auto">
        <div className="w-full max-w-md px-6 sm:px-10 py-10 pt-[130px] lg:pt-[100px]">
          ...
          {step === "email" && (
            <div>
              <div className="space-y-1.5 mb-7">
                <h1 className="text-3xl text-[#35093C] font-cormorant" style={{ fontWeight: 600 }}>Forgot password?</h1>
              ...
              <form onSubmit={sendOtp} className="space-y-4">
                ...
                <button
                  ...
                  style={{ background: emailLoading ? "#374151" : "linear-gradient(135deg, #35093C 0%, #e42a6c 100%)" }}
                >
                  {emailLoading ? (
          ...
          {step === "otp" && (
            <div>
              <div className="space-y-1.5 mb-7">
                <h1 className="text-3xl text-[#35093C] font-cormorant" style={{ fontWeight: 600 }}>Check your email</h1>
              ...
              <form onSubmit={verifyOtp} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full h-11 flex items-center justify-center gap-2 font-semibold text-sm rounded-xl text-white transition-all duration-300 disabled:cursor-not-allowed mt-2"
                  style={{ background: otpLoading ? "#374151" : "linear-gradient(135deg, #35093C 0%, #e42a6c 100%)" }}
                >
                  {otpLoading ? (
          ...
          {step === "password" && (
            <div>
              <div className="space-y-1.5 mb-7">
                <h1 className="text-3xl text-[#35093C] font-cormorant" style={{ fontWeight: 600 }}>New password</h1>
              ...
              <form onSubmit={resetPassword} className="space-y-4">
                ...
                <button
                  ...
                  disabled={pwLoading}
                  className="w-full h-11 flex items-center justify-center gap-2 font-semibold text-sm rounded-xl text-white transition-all duration-300 disabled:cursor-not-allowed mt-2"
                  style={{ background: pwLoading ? "#374151" : "linear-gradient(135deg, #35093C 0%, #e42a6c 100%)" }}
                >
                  {pwLoading ? (
          ...
          {step === "done" && (
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                <h1 className="text-3xl text-[#35093C] font-cormorant" style={{ fontWeight: 600 }}>Password reset!</h1>
              ...
              <button
                ...
                style={{ background: "linear-gradient(135deg, #35093C 0%, #e42a6c 100%)" }}
              >
