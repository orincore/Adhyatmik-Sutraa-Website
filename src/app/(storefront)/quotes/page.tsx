...
export default async function QuotesPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      {/* Hero */}
      <div style={{ background: "linear-gradient(120deg, #240429 0%, #35093C 40%, #542b54 75%, #7B3F7A 100%)" }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-20 sm:pt-24 pb-8 sm:pb-10 flex items-end justify-between gap-6">
          <div>
            <p className="text-[10px] uppercase tracking-[0.3em] font-semibold mb-1" style={{ color: "#ff94ba" }}>
              Daily Wisdom
            </p>
            <h1 className="text-2xl sm:text-4xl font-bold text-white leading-tight" style={{ fontFamily: "'Marcellus', serif" }}>
              Quotes of the Day
            </h1>
        ...
        {todayQuote && (
          <div className="mb-10">
            ...
            <div
              ...
              style={{ background: "linear-gradient(135deg, #9d1749 0%, #663367 50%, #c01b58 100%)" }}
            >
              {/* Decorative blobs */}
