    ...
    <div className="min-h-screen bg-stone-50 py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-stone-700 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>Disclaimer</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>External Links Disclaimer</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>Errors and Omissions Disclaimer</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>Fair Use Disclaimer</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>Views Expressed Disclaimer</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>No Responsibility Disclaimer</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>"Use at Your Own Risk" Disclaimer</h2>
