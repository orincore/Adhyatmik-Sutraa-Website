    ...
    <div className="min-h-screen bg-stone-50 py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-stone-700 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>1. No Refund Policy</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>2. Reason for No Refunds</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>3. Order Confirmation</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>4. Exceptions (If Applicable)</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>5. Contact Us</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>6. Policy Acceptance</h2>
