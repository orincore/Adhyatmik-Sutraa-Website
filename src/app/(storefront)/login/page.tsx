    ...
    <div style={{ transition: "opacity 0.5s, transform 0.5s", opacity: success ? 0 : 1, transform: success ? "scale(0.95) translateY(16px)" : "scale(1) translateY(0)" }}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          style={{ background: success ? "#e42a6c" : loading ? "#374151" : "linear-gradient(135deg, #35093C 0%, #e42a6c 100%)" }}
        >
          {loading ? (
  ...
  return (
    <div style={{ transition: "opacity 0.5s, transform 0.5s", opacity: success ? 0 : 1, transform: success ? "scale(0.95) translateY(16px)" : "scale(1) translateY(0)" }}>
      <div className="space-y-1.5 mb-6">
        <h1 className="text-3xl text-[#35093C] font-cormorant" style={{ fontWeight: 600 }}>Create account</h1>
    ...
    <div className="min-h-screen flex overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          background: isLogin
            ? "linear-gradient(145deg, #240429 0%, #35093C 45%, #542b54 100%)"
            : "linear-gradient(145deg, #542b54 0%, #35093C 45%, #240429 100%)",
        }}
      >
        {/* Animated blobs */}
        <div
          ...
          style={{
            ...
            top: isLogin ? -80 : -40,
            left: isLogin ? -80 : -120,
            background: "radial-gradient(circle, #ff94ba, transparent)",
