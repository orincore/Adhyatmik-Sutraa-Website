    ...
    <div className="min-h-screen bg-stone-50 py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-stone-700 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>1. Order Processing</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>2. Shipping Charges</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>3. Delivery Timelines</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>4. Shipping Coverage</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>5. Order Tracking</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>6. Packaging</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>7. Damaged or Lost Shipments</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>8. Digital Products & Courses</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-stone-800 mb-3" style={{ fontFamily: "'Marcellus', serif" }}>9. Contact Us</h2>
