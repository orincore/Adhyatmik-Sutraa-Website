...
// Live-site typography (adhyatmiksutraa.com): Marcellus for headings,
// Open Sans for body text. Kept on the legacy CSS variable names so the
// rest of the styling (tailwind font-playfair/font-cormorant) picks them up.
const inter = Open_Sans({ subsets: ["latin"], variable: "--font-inter" });

const playfair = Marcellus({
  subsets: ["latin"],
  variable: "--font-playfair",
  weight: ["400"],
});

const cormorant = Marcellus({
  subsets: ["latin"],
