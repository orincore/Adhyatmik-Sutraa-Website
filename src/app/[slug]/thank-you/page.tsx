    ...
    <div className="min-h-screen flex flex-col bg-stone-50">
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-20 px-4 text-center bg-gradient-to-b from-emerald-50/60 to-stone-50">
        <div className="max-w-lg w-full mx-auto space-y-6">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-stone-800" style={{ fontFamily: "'Marcellus', serif" }}>
            {data.title}
          </h1>
          ...
          {data.buttons.length > 0 && (
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 pt-2">
              {data.buttons.map((btn, i) => {
                const s = ICON_STYLES[btn.icon] || { bg: "#FD4380", text: "#ffffff" };
                return (
                  <a
                    key={i}
                    href={btn.url || "#"}
      ...
      <div className="py-14 px-4 text-center bg-gradient-to-br from-emerald-900 via-teal-900 to-blue-900">
        <p className="text-2xl sm:text-3xl font-bold mb-2 text-gradient-peacock" style={{ fontFamily: "'Marcellus', serif" }}>
