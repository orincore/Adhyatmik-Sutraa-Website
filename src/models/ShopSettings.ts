...
const ShopSettingsSchema = new Schema<IShopSettings>(
  {
    ...
    cardHoverBorderColor: { type: String, default: "#ffc2d8" },
    ...
    priceColor: { type: String, default: "#c01b58" },
    ...
    buttonBgColor: { type: String, default: "#e42a6c" },
    buttonTextColor: { type: String, default: "#ffffff" },
    buttonBorderColor: { type: String, default: "#e42a6c" },
    buttonHoverBg: { type: String, default: "#c01b58" },
